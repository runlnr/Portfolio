...
- **Pages**:
  - `index.html`: Hero home page with 5-column navigation & difference blend mode.
  - `works.html`: Works catalog with Grid/List view toggle and hover-following previews.
